...
def to_json (hash_array)
  File.open("/Users/quentinberson/THP/Google_Drive/scrap_mairie.json","w") { |f|
    f.write(hash_array.to_json)
}
end
...
def perform
  ...
  to_json(scan_list_mairie(url_origin))
end
